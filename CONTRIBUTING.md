...
Thank you for your interest in contributing. PayProbe is built by payment engineers for payment engineers — your real-world experience is the most valuable thing you can bring.

## Ways to Contribute

| Type | Examples | Difficulty |
|---|---|---|
| **New adapter** | Add support for a new payment server, HSM vendor, or switch | Medium |
| **Bug fix** | Fix a defect in the worker engine, portal, or backend services | Low–Medium |
| **Scenario examples** | Add example test scenarios for common payment flows | Low |
...
This is the highest-value contribution. A new adapter adds support for a payment system component that PayProbe doesn't yet know about.
...
- **All tests must pass** — `scripts/test-all.sh` must exit 0
