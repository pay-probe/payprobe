...
| **How‑to guide** | getting one specific job done | [Writing an adapter](adapters/writing-an-adapter.md) · [gRPC adapter](adapters/grpc.md) · [Database probe](adapters/db-probe.md) · [Code step](scenarios/code-step.md) · [Participant flows end to end](participant-flow-end-to-end-guide.md) · [Authoring a provider pack](authoring-a-provider-pack.md) · [Load test runbook](operations/load-test-runbook.md) · [Offline minimal deployment](operations/offline-minimal-deployment.md) |
